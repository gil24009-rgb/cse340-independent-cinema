...
| Multiple roles | Owner, Staff, Member | role middleware and active-user reload | Member dashboard, Staff booking operations, review moderation, message processing, Owner management screens | Permission matrix, mutation tests, stale-session tests | Verified |
...
| Server-side rendering | Home, film, screening, visit, contact, public visitor pathway, Member booking history and timeline, Member review CRUD, Member account overview, Staff booking operations, screening roster, review moderation, contact message processing, Owner user management, account, auth page EJS rendering | Express controllers and EJS | Public home pathway, film archive, screening schedule, detail pages, visit contact form, Member booking overview, Member booking list and detail timeline, Member review list and forms, Staff booking dashboard, screening roster, moderation queue, message queue, Owner users, auth and account pages | Automated route tests and browser inspection | Verified |
...
| Multi-stage workflow | Member booking creation, Member booking history, Member-owned cancellation, Member-facing status timeline, Staff status transitions, and Staff screening roster grouping are implemented | bookings and status history | Screening detail booking action, Member account overview, Member booking detail, Member booking history, cancellation state, status timeline, Staff booking controls, and grouped Staff roster | Route, PostgreSQL transaction, browser, and conflict tests | Verified |
...
| Admin dashboard | Operational management | Aggregated queries and CRUD | Staff booking operations overview, grouped screenings, review moderation, Staff message queue, Owner film/screening/user management with mobile row labels | Role test, SSR inspection, browser checks, and PostgreSQL integration tests | Verified |

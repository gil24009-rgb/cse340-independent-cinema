...
| Admin content management | Initial Owner film visibility management, then film and screening CRUD | Owner controllers and models | Owner film catalog and later management forms | Owner route and public reflection tests | In Progress |

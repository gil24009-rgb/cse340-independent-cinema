...
| Multiple roles | Owner, Staff, Member | role middleware | Member dashboard, Staff booking operations, review moderation, message processing, Owner management screens | Permission matrix and mutation tests | In Progress |
...
| Server-side rendering | Home, film, screening, visit, contact, Member booking history and timeline, Member review CRUD, Staff booking operations, screening roster, review moderation, contact message processing, account, auth page EJS rendering | Express controllers and EJS | Public home, film archive, screening schedule, detail pages, visit contact form, Member booking list and detail timeline, Member review list and forms, Staff booking dashboard, screening roster, moderation queue, message queue, auth and account pages | Automated route tests and browser inspection | In Progress |
...
| Admin dashboard | Operational management | Aggregated queries and CRUD | Staff booking operations grouped by screening, Staff review moderation, Staff message queue, and later Owner dashboard | Role test, SSR inspection, browser checks, and PostgreSQL integration tests | In Progress |

...
| Admin content management | Initial Owner film visibility and screening cancellation controls, then film and screening CRUD | Owner controllers and models | Owner film catalog, Owner screening schedule, and later management forms | Owner route, conflict, and public reflection tests | In Progress |

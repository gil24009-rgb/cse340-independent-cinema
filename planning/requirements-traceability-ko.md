...
| Admin content management | Owner film create, edit, visibility controls, and initial screening cancellation controls, then remaining screening CRUD | Owner controllers and models | Owner film catalog, Owner film forms, Owner screening schedule, and later screening forms | Owner route, validation, conflict, and public reflection tests | In Progress |

...
| Admin dashboard | Operational management | Aggregated queries and CRUD | Staff booking operations grouped by screening, Staff review moderation, Staff message queue, Owner film/screening/user management with mobile row labels | Role test, SSR inspection, browser checks, and PostgreSQL integration tests | Verified |
